...
do this is via
[ORY Kubernetes Resources Discussions](https://github.com/ory/meta/discussions)
...
Check out [ORY Kubernetes Resources Discussions](https://github.com/ory/meta/discussions). This is a great place for
...
[docs](https://github.com/ory/k8s/tree/master/docs) folder. Generate API and
configuration reference documentation using `cd docs; npm run gen`.

For further instructions please head over to
[docs/README.md](https://github.com/ory/k8s/blob/master/README.md).
...
1. Ensure that each commit has a subsystem prefix (ex: `controller:`).
   [List of subsystem prefixes for Kubernetes Resources](https://github.com/ory/ory/k8s/blob/master/.github/semantic.yml)
   (if applicable).
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the ORY Kubernetes Resources
