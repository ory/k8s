...
# Contributing to Ory Kubernetes Resources
...
_Please note_: We take Ory Kubernetes Resources's security and our users' trust very seriously. If you believe you have found a security issue
in Ory Kubernetes Resources, please responsibly disclose by contacting us at security@ory.sh.
...
Kubernetes Resources's normal direction. A great way to
do this is via
[Ory Kubernetes Resources Discussions](https://github.com/orgs/ory/discussions) or the
[Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/k8s/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get [answers to questions regarding Ory Kubernetes Resources?](#communication)
...
- I want to talk to other Ory Kubernetes Resources users. [How can I become a part of the community?](#communication)
...
- **Give us a star.** It may not seem like much, but it really makes a difference. This is something that everyone can do to help
  out Ory Kubernetes Resources. Github stars help the project gain visibility and stand out.
...
- **Helping with open issues.** We have a lot of open issues for Ory Kubernetes Resources and some of them may lack necessary information,
...
Check out [Ory Kubernetes Resources Discussions](https://github.com/orgs/ory/discussions). This is a great place for in-depth discussions and lots of code examples, logs
and similar data.
...
If you want to receive regular notifications about updates to Ory Kubernetes Resources, consider joining the mailing list. We will _only_ send
...
[in our chat](https://www.ory.sh/chat) before getting started to ensure your work is consistent with Ory Kubernetes Resources's roadmap and
architecture.
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform commit history and helps structure the changelog.  
   Please refer to this [list of prefixes for Kubernetes Resources](https://github.com/ory/k8s/blob/master/.github/semantic.yml) for an
   overview.
...
5. have signed our [Contributor License Agreement](https://cla-assistant.io/ory/k8s);
...
[docs](https://github.com/ory/k8s/tree/master/docs) folder. Generate API and configuration reference documentation using
`cd docs; npm run gen`.

For further instructions please head over to [docs/README.md](https://github.com/ory/k8s/blob/master/README.md).
...
- Private harassment is also unacceptable. No matter who you are, if you feel you have been or are being harassed or made
  uncomfortable by a community member, please contact one of the channel ops or a member of the Ory Kubernetes Resources core team
  immediately.
