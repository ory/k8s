...
won't clash or be obviated by ORY Kubernetes Resources's normal direction. A great way to
do this is via
[ORY Kubernetes Resources Discussions](https://github.com/ory/Kubernetes Resources/discussions) or
the [ORY Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [ORY Community Code of Conduct?](https://github.com/ory/Kubernetes Resources/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding ORY Kubernetes Resources?](#communication)
...
- I would like to know what I am agreeing to when I contribute to ORY
  Kubernetes Resources. Does ORY have
...
[list of good first issues](https://github.com/ory/Kubernetes Resources/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a
  ...
  Kubernetes Resources. Github stars help the project gain visibility and stand out.
...
- **Helping with open issues.** We have a lot of open issues for ORY Kubernetes Resources
...
Check out
[ORY Kubernetes Resources Discussions](https://github.com/ory/Kubernetes Resources/discussions).
...
[docs](https://github.com/ory/Kubernetes Resources/tree/master/docs) folder. Generate API
and configuration reference documentation using `cd docs; npm run gen`.

For further instructions please head over to
[docs/README.md](https://github.com/ory/Kubernetes Resources/blob/master/README.md).
...
git clone git@github.com:ory/Kubernetes Resources.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/Kubernetes Resources.git
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  Kubernetes Resources core team immediately.
