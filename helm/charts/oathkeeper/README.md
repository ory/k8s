...
![Version: 0.21.7](https://img.shields.io/badge/Version-0.21.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.38.9-beta.1](https://img.shields.io/badge/AppVersion-v0.38.9--beta.1-informational?style=flat-square)
...
|------------|------|---------|
| file://../oathkeeper-maester | oathkeeper-maester(oathkeeper-maester) | 0.21.7 |
...
| image.tag | string | `"v0.38.17-beta.1"` | ORY Oathkeeper version |
