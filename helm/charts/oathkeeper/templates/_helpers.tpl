...
{{/*
Get name for ConfigMap resource
*/}}
{{- define "oathkeeper.getCM" -}}
{{- if .Values.oathkeeper.configMapName -}}
{{- printf "%s" .Values.oathkeeper.configMapName -}}
{{- else -}}
{{- printf "%s" (include "oathkeeper.fullname" .) -}}
{{- end -}}