...
![Version: 0.23.3](https://img.shields.io/badge/Version-0.23.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.9.0-alpha.2](https://img.shields.io/badge/AppVersion-v0.9.0--alpha.2-informational?style=flat-square)
...
| kratos.automigration.enabled | bool | `false` | Enable the automigration. Required to work with a DB |
| kratos.automigration.type | string | `job` | Configure the way to execute database migration. Possible values: 'job', 'initContainer'. When set to job, the migration will be executed as a job on release or upgrade. When set to initContainer, the migration will be executed when kratos pod is created     |
