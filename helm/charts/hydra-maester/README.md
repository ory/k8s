...
![Version: 0.62.0](https://img.shields.io/badge/Version-0.62.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.0.42](https://img.shields.io/badge/AppVersion-v0.0.42-informational?style=flat-square)
...
| image.tag | string | `"v0.0.42"` | Ory Hydra-maester version |
